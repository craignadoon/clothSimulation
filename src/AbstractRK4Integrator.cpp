...
//----------------------------------------------------------------------------------------------------------------------
/// @file   AbstractRK4Integrator.cpp
/// @brief  Abstract Rk4 integrator to caculate the state of mass particles by runge-kutte method
//----------------------------------------------------------------------------------------------------------------------
                                        ...
                                        )
{
    ...
    //std::cout<<"\n integate val: pos="<<m_state.m_position<<" vel = "<<m_state.m_velocity;
}
